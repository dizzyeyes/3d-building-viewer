...
dat.dom.dom = function(e) {
	...
	f = {
		makeSelectable: function(b, a) {
			if (! (b === void 0 || b.style === void 0)) b.onselectstart = a ?
			function() {
				return false
			}: function() {},
...
dat.color.interpret = function(e, a) {
	...
	return function() {
		...
		a.each(f,
		function(e) {
			if (e.litmus(b)) return a.each(e.conversions,
			function(e, f) {
				c = e.read(b);
...
dat.GUI = dat.gui.GUI = function(e, a, c, d, f, b, n, h, j, m, l, o, y, g, i) {
	...
	function p(a, d, c) {
		...
		if (c instanceof j) {
			...
			i.each(["updateDisplay", "onChange", "onFinishChange"],
			function(a) {
				var b = c[a],
				H = e[a];
				c[a] = e[a] = function() {
		...
		} else if (c instanceof b) g.bind(d, "click",
		function() {
			g.fakeEvent(c.__checkbox, "click")
		}),
		g.bind(c.__checkbox, "click",
		function(a) {
			a.stopPropagation()
		});
		else if (c instanceof n) g.bind(d, "click",
		function() {
	...
	function I(a) {
		...
		a.load && a.load.remembered ? i.each(a.load.remembered,
		function(b, c) {
			C(a, c, c == a.preset)
		}) : C(a, w, false);
		g.bind(m, "change",
	...
	function z(a, b) {
		var c = {};
		i.each(a.__rememberedObjects,
		function(d, e) {
			var f = {};
			i.each(a.__rememberedObjectIndecesToControllers[e],
			function(a, c) {
	...
	i.extend(k.prototype, {
		...
		remember: function() {
			...
			var b = this;
			i.each(Array.prototype.slice.call(arguments),
			function(a) {
