BdViewer.MPoint= function(id,name,type, model,position,rotation,scale,texture,info,modelbias,modelbaseHeight) {
...
BdViewer.MPoint.prototype.copy=function(mpoint)
{    
    this.type = mpoint.type;
    this.model=new BdViewer.model();this.model.copy(mpoint.model);
...
BdViewer.MPoint.prototype.serializeXML = function(){        
    var rtn="";
    rtn+="<MPoint";
    rtn+=" id=\""+this.id+"\"";
    ...
    var x = this.position.x - this.modelbias.x , y = this.position.y - this.modelbias.y - this.modelbaseHeight.mpoint, z = this.position.z-this.modelbias.z;
...
BdViewer.MPoint.prototype.serializeJSON = function(){        
    var rtn="";
    rtn+="{\"MPoint\":{";
    rtn+="\"-id\":\""+this.id+"\",";
